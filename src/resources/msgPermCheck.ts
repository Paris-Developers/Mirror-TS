...
export async function msgPermsCheck(client: Client, message: Message, permissionsToCheck: Array<bigint>): Promise<boolean> {
    let guildMember: GuildMember = await message.guild!.members.fetch(client.user!);
